...
class RubiksCube777(RubiksCubeNNNOddEdges):
    ...
    def stage_UD_centers(self):
        ...
        self.print_cube()
        print("Solution_777_p4: %s" % " ".join(self.solution))
        sys.stdout.flush()
        logger.info(
        ...
        print("Solution_777_p5: %s" % " ".join(self.solution))
        sys.stdout.flush()
        logger.info(
        ...
        print("Solution_777_p6: %s" % " ".join(self.solution))
        sys.stdout.flush()
    ...
    def stage_LR_centers(self):
        ...
        print("Solution_777_p1: %s" % " ".join(self.solution))
        sys.stdout.flush()
        self.print_cube()
        logger.info(
        ...
        print("Solution_777_p2: %s" % " ".join(self.solution))
        sys.stdout.flush()
        logger.info(
        ...
        print("Solution_777_p3: %s" % " ".join(self.solution))
        sys.stdout.flush()
    ...
    def LR_centers_vertical_bars(self):
        ...
        print("Solution_777_p7: %s" % " ".join(self.solution))
        sys.stdout.flush()
        logger.info(
    ...
    def UD_centers_vertical_bars(self):
        ...
        print("Solution_777_p8: %s" % " ".join(self.solution))
        sys.stdout.flush()
        logger.info(
    ...
    def centers_daisy_solve(self):
        ...
        print("Solution_777_p9: %s" % " ".join(self.solution))
        sys.stdout.flush()
        self.print_cube()
        logger.info(
